...
<html>
  ...
  <div align="center">
   <p>&nbsp;&nbsp;&nbsp;
   <p>
   <U><a href=lookadd.jsp style="color:#0000FF">添加&nbsp;&nbsp;</a></U>
   ...
   int pageCount=0; //分页后的总页数。
     ...
     <%  //获取数据库mysql的驱动类
         ...
         try{
            ...
            String sql="SELECT No,Name,Type,Specifications,Place,Supplier,Borrowed FROM fixedassets";
...
%> 
             ...
             <td class="td" >
             <u><a href=lookmodify.jsp?No=<%=(No)%> style="color:#0000FF">修改</a></u>
             &nbsp;&nbsp;
             <u><a href=delect.jsp?No=<%=(No)%> style="color:#0000FF">删除</a></u>
             </td>
             </tr>
<%              rs.next();
           }
...
%>
      ...
      <tr>
       <td width = td.width><U><a href=lookfixedassets.jsp?showPage1=1 style="color:#0000FF" >首页 &nbsp;&nbsp;</a></U></td>
       <td width = td.width><U><a href=lookfixedassets.jsp?showPage1=<%=(showPage-1)%> style="color:#0000FF" >前一页&nbsp;&nbsp;</a></U></td> 
       <td width = td.width><U><a href=lookfixedassets.jsp?showPage1=<%=(showPage+1)%> style="color:#0000FF" >后一页&nbsp;&nbsp;</a></U></td>
       <td width = td.width><U><a href=lookfixedassets.jsp?showPage1=<%=(pageCount)%> style="color:#0000FF" >末页&nbsp;&nbsp;</a></U></td>
       <td width = td.width >每页<%=pageSize%>行&nbsp;&nbsp;</td>
       <td width = td.width >现在是第<%=showPage%>页/共<%=pageCount%>页 &nbsp;</td>
       <form name="form1" method="post" action="lookfixedassets.jsp">
