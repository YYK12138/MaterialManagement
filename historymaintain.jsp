  ...
  <table border="0"> 
   ...
   <tr  height="45">
	...
	<td width="200" ><input type="submit" class="button" value="提交">
     ...
     <%  
         try{
           ...
           for (int i=1;i<=pageSize;i++){
              ...
              out.print("<a href=*****.jsp?******="+No+ " class='button'>"+"详细信息"+"</a>");
              out.print("&nbsp;");out.print("&nbsp;");
              out.print("</td>");
              out.print("</tr>");
              rs.next();
     ...
     <tr>
       <td width="43"><a href=historymaintain.jsp?showPage1=1 >首页</a></td>
       <td width="59"><a href=historymaintain.jsp?showPage1=<%=(showPage-1)%> >前一页</a></td>
       <td width="58"><a href=historymaintain.jsp?showPage1=<%=(showPage+1)%> >下一页</a></td>
       <td width="51"><a href=historymaintain.jsp?showPage1=<%=(pageCount)%> >末页</a></td>
