...
<div align="center">
<p>&nbsp; 
<%! String Name =null,Type=null,Specifications=null,Place = null,Supplier=null;
    Connection con;
	Statement stmt;
	String sql;
%>
<%  
    ...
    try{
     ...
     try{
        ...
        sql="select * from consumableassets where No='"+No+"'";
...
%>
<form name="form4" method="post" action="modifyHandle2.jsp">
<table class ="table" cellpadding="0" cellspacing="0">
 ...
 <p> &nbsp; 
  <p> &nbsp; 
<u><a href="lookconsumableassets.jsp" style="color:#0000FF">返回列表</a></u>
</body>
</html>
